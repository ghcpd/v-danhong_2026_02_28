...
def ping_host(hostname: str) -> str:
    ...
    # Use list arguments and shell=False to avoid OS command injection.
...
def deserialize_user_data(encoded: str) -> Any:
    ...
    # Avoid unsafe deserialization (pickle) on untrusted input.
    # JSON is safe for basic structured data.
